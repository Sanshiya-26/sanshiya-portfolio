            ...
            <div key={index} className="bg-gray-50 p-6 rounded-xl shadow hover:shadow-md transition">
              ...
              <div className="flex gap-4">
                <a href={project.code} target="_blank" rel="noopener noreferrer"
                   href="https://github.com/Sanshiya-26/flask-study-recommender" target="_blank" rel="noopener noreferrer" href="https://github.com/Sanshiya-26/DS_Study_Planner" target="_blank" rel="noopener noreferrer" className="text-sm px-4 py-2 border border-indigo-600 text-indigo-600 rounded hover:bg-indigo-50">View Code</a>
